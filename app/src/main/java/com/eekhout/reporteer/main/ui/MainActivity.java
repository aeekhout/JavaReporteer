...
import com.eekhout.reporteer.photolist.ui.PhotoListDialog;
import com.eekhout.reporteer.photolist.ui.PhotoListDialogInteractor;
...
import com.eekhout.reporteer.PhotoFeedApp;
...
public class MainActivity extends AppCompatActivity implements MainView, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, PhotoListDialogInteractor {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK && requestCode == REQUEST_PICTURE) {
            ...
            presenter.uploadPhoto(lastLocation, photoPath, descripcion);
        }
    }
    ...
    private void CallDialog() {
        DialogFragment dialog = new PhotoListDialog();
        dialog.show(getSupportFragmentManager(), "");
    }

    @Override
    public void onDialogPositiveClick(DialogFragment dialog, String descripcionUsuario) {
    ...
    @Override
    public void onDialogNegativeClick(DialogFragment dialog, String descripcion) {
